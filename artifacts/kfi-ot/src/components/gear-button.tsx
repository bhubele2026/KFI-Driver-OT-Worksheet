...
/**
 * The owner's gear — top right, the way the Financial Dashboard and Housing
 * carry it. Settings stopped being a tile on 2026-09-01: it reaches exactly
 * one person, so it lives in the chrome, not the grid.
 */
export function GearButton({ className }: { className?: string }) {
