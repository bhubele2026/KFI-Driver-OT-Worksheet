...
const STORAGE_KEY = "kfi-ot:auto-advance-reviewed:v1";
const EVENT_NAME = "kfi-ot:auto-advance-reviewed:change";
...
export function useAutoAdvancePref(): [boolean, (next: boolean) => void] {
